...
export default function AdminDashboard({ auth }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="flex pt-4 pl-4" style={{ height: '1000px' }}>
                <aside className="bg-gray-500 w-40 flex flex-col items-center py-5 rounded-full">
                    ...
                    >
                        ...
                        <Link href="/addproduct" className="text-yellow-500 py-5  ">
                        ...
                        <Link href="/editproducts" className="text-yellow-500 py-5  ">
                          <div className="group flex flex-col items-center text-center">
                                <svg
                                    className="w-10 h-10 group-hover:text-green-500"
                                    fill="currentColor"
                        ...
                        <Link href="/stocks" className="text-yellow-500 py-5  ">
                          <div className="group flex flex-col items-center text-center">
                                <svg
                                    className="w-10 h-10 group-hover:text-green-500"
                                    fill="currentColor"
                        ...
                        <Link href="/userlist" className="text-yellow-500 py-5  ">
                          <div className="group flex flex-col items-center text-center">
                                <svg
                                    className="w-10 h-10 group-hover:text-green-500"
                                    fill="currentColor"
                        ...
                        <Link href="/sales" className="text-yellow-500 py-5  ">
                            <div className="group flex flex-col items-center text-center">
                                <svg
                                    className="w-10 h-10 group-hover:text-green-500"
                                    fill="currentColor"
                        ...
                        <div className="">
                            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <div className="bg-gray-200 p-4 rounded-lg shadow-md relative">
                                    ...
                                    <div className="flex flex-wrap -mx-2 gap-12 mt-6">
                                        {handleSearch().map((product, index) => (
                                            <div key={product.id} className={`p-2 text-center bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md relative`}>
                                                <img
