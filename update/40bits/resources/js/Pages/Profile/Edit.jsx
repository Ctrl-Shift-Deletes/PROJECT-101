...
export default function Edit({ auth, mustVerifyEmail, status }) {
    return (
        <>
            ...
            <div className="flex items-center justify-center" style={{ background: '#111827', color: '#fff' }}>
                <div className="absolute top-4 left-4">
                    <Link
                        href={route('admin.dashboard')}
                        className="text-white py-2 px-4 rounded bg-green-400 hover:bg-green-500"
                    >
                        Back
                    </Link>
                </div>
                ...
                <div className="flex items-center justify-center">
                    <div className="bg-gray-300 p-10 rounded-lg shadow-md" style={{ width: '60rem', height: 'auto', color: '#111827' }}>
