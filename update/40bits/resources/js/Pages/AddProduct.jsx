...
export default function AddProduct({ auth }) {
    ...
    return (
        <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50 flex items-center 
        justify-center min-h-screen"style={{background: '#111827' }}>
            <div className="flex items-center">
                <div className="p-10 bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col">
                    <h2 className="text-4xl md:text-4xl text-center font-semibold text-black dark:text-white">Add Product</h2>
