...
function Stocks() {
    ...
    return (
        <div className="p-4"style={{background: '#111827', height: '900px' }}>
            ...
            <h1 className="text-4xl font-bold text-white mb-4 text-center pt-10 pd-12">Remaining Stocks</h1>
            <table className="min-w-full border-collapse border border-black">
                <thead>
                    ...
                    <tr>
                        <th style={{ width: '15%' }} className="border border-black px-4 py-2 bg-gray-200">Name</th>
                        ...
                        <th style={{ width: '10%' }} className="border border-black px-1 py-2 bg-gray-200">Stocks</th>
                    </tr>
                </thead>
                <tbody>
                    {filteredProducts.map(product => (
                        <tr key={product.id} className={getRowClass(product.stock)}>
                            <td style={{ width: '15%' }} className="border border-black text-center px-4 py-2">{product.name}</td>
                            ...
                            <td style={{ width: '10%' }} className="border border-black text-center px-1 py-2">{product.stock}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
