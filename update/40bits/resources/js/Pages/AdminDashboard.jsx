...
export default function AdminDashboard({ auth }) {
    ...
    return (
        <>
            ...
            <div className="flex pt-4 pl-9 pb-5 " style={{ height: '900px' , background: '#111827', overflowY: 'auto' }}>
                    ...
                    <main className="p-4">
                        <div className="">
                            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <div className="bg-gray-900 p-4 pjustify-between rounded-lg text-center "> 
                                    ...
                                    <div className="flex flex-wrap mx-2 bg-gray-900 pl-4 gap-5 mt-6">
