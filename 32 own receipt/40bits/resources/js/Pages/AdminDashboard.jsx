...
export default function AdminDashboard({ auth }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="flex pt-4 pl-4" style={{ height: '1050px' }}>
                <aside className="bg-gray-500 w-40 flex flex-col items-center py-5 rounded-full">
                    ...
                    >
                        ...
                        <Link href="/transactionhistory" className="text-yellow-500 py-4 pl-4  ">
                            <div className="group flex flex-col items-center text-center">
                                <svg
                                    className="w-10 h-10 group-hover:text-green-500"
                                    fill="currentColor"
                                ...
                                <h1 className="ml-2 mr-5 mt-1 group-hover:text-green-500">Transaction History</h1>
                            </div>
                        </Link>
