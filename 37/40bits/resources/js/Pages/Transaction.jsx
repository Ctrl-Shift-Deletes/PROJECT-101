                ...
                <div className="mb-5 mt-2 text-center">
                    <label className="text-sm font-medium text-gray-700">
                        ...
                        <input
                            ...
                            required // Required attribute to enforce field is not empty
                            className="mt-1 block w-1/2 px-3 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md mx-auto"
                        />
                    </label>
                </div>
